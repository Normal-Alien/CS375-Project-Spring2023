...
public class TresController {
	...
	private void toMenuItem(ActionEvent event) throws IOException{
		...
		//BorderPane aa = (BorderPane) root.lookup("#AA");
		//SplitPane a = (SplitPane) aa.lookup("#A");
		//System.out.println(a);
		//AnchorPane b = (AnchorPane) a.lookup("#C"); //this gets set to null for some reason
